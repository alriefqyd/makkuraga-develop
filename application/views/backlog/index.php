      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          if($level_user == 'Master Admin'           ||
            ...
            $access = ''
            ?>
            <center><button style="margin-top: 15px" type="button" class="btn btn-success add_backlog" data-toggle="modal" data-target=".bs-example-modal-lg">Input Backlog</button></center><hr/>
            <?php
          }
          ?>
          <!-- <?php var_dump($ID) ?> -->
