    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <button type="button" class="btn btn-success" data-toggle="modal" data-target=".bs-example-modal-lg">Input Mechanic</button><hr/>
     ...
     <div class="x_content data-backlog">
       ...
       <tbody class="body-backlog">
            ...
            <tr id="<?php echo $mechanic['id']?>">
              ...
              <td><a href="mechanic/edit"><i class="fa fa-edit"></i> Edit</a>  <a href="Delete"><i class="fa fa-trash"></i>Delete</a>
