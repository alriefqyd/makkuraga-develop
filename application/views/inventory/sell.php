    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="col-md-12">
            <button type="button" class="btn btn-success <?php echo $level_user == "Mekanik Admin All Area" || $level_user == "User All Area" || $level_user == "User Asera" || $level_user == "User Kodal" ? "hidden" : "" ?>" data-toggle="modal" data-target=".modal-add-inventory">Input Data Item</button><hr/>
               ...
               <div class="bs-example-popovers">
                 <div class="btn-group" data-toggle="buttons">
                  <label class="btn btn-default">
                    <input type="radio" class="js-auto-submit" name="low_stock" id="option1"> Low Stock
                  </label>
