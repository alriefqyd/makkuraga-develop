    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          $hide = '';
          ?>
          <center><button style="margin-top: 15px" type="button" class="btn btn-success add_backlog" data-toggle="modal" data-target=".bs-example-modal-lg">Input PM</button><hr/></center>
          <?php
        }?>
            ...
            <div class="col-md-2 col-sm-2 col-xs-12">
             <select name="ID" data-placeholder="Pilih ID" class="form-control select-search js-auto-submit" style="width:100%">
               ...
               <?php foreach ($ID as $ID ) { ?>
                <option <?php if(isset($_GET['ID'])){if($_GET['ID'] == $ID['ID']){echo "selected";}}?> value="<?php echo $ID['ID'] ?>"><?php echo $ID['ID'] ?></option>
              <?php } ?>
            </select> 
          </div>
          <div class="col-md-2 col-sm-2 col-xs-12">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Input PM</h4>
          </div>
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="x_content">
                         ...
                         <div class="item form-group">
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                             <select name="prioritas" id="heard" class="form-control select location" style="width:100%">
