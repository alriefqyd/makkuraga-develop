    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <button type="button" class="btn btn-success" data-toggle="modal" data-target=".bs-example-modal-lg">Input Backlog</button><hr/>
          <div class="modal fade bs-example-modal-lg modal-add" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="x_content">
                          <div class="row">
                            ...
                            <div class="x_content">
                              ...
                              <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">Masukkan Status <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <textarea id="textarea" required="required" name="status" class="form-control col-md-7 col-xs-12 status"></textarea>
                                </div>
                              </div>
              ...
              <div class="control-group">
                <div class="controls">
                  <div class="col-md-6 col-sm-6 col-xs-12 xdisplay_inputx form-group has-feedback">
                    <input type="text" value="<?php echo $backlog['down_date']?>" autocomplete="off" data-id="<?php echo $backlog['id_backlog']?>" class="form-control has-feedback-left js-down_date" id="down_date" placeholder="Down Date" name="down_date" aria-describedby="inputSuccess2Status3">
